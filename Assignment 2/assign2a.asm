// This program performs the multiplication 70 * (-16843010)
...
main:	stp	x29, x30, [sp, -16]!		// 
	...
	mov	multiplicand, -16843010		// give multiplicand value of -16843010
	mov	multiplier, 70			// give multiplier value of 70
