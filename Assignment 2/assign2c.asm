// This program performs the multiplication -256 * (-252645136)
...
main:	stp	x29, x30, [sp, -16]!		// 
	...
	mov	multiplicand, -252645136	// give multiplicand value of -252645136
	mov	multiplier, -256		// give multiplier value of -256
